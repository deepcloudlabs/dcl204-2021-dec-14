...
public class StudyParallelProgramming extends Object {
	private static final String FORMAT = "Method: %24s Volume: %16.3f Duration: %16d";
	...
	public static void computeVolumeSerialFunctional() {
		var begin = System.nanoTime();
		var volume = trades.stream()
				.mapToDouble(Trade::getVolume).sum();
		var end = System.nanoTime();
	...
	public static void computeVolumeParallelForkJoinPool() {
		...
		var begin = System.nanoTime();
		VolumeIndicatorRecursiveTask task = new VolumeIndicatorRecursiveTask(trades, 0, trades.size());
